Make a list of files in the current directory recursively with their full paths
dir /b /s /a:-D > <filename>.txt
dir /b /s /a:-D > modfiles.txt

Make a list of files of current folder recursively with their file sizes
